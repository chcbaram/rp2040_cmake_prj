...
Adafruit_NeoPixel::Adafruit_NeoPixel() :
  ...
  is800KHz(true),
#endif
  begun(false), numLEDs(0), numBytes(0), pin(-1), brightness(0), pixels(NULL), opixels(NULL), brightfr(NULL), rOffset(1), gOffset(0), bOffset(2), wOffset(1), brightfb(NULL), brightfw(NULL), brightfg(NULL){
  endTime = get_absolute_time();
}
